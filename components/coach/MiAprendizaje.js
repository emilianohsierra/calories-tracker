...
// Panel (hoja) de Mi aprendizaje. Componente propio → monta al abrir, para que useModalA11y
// (foco/trampa/Escape/scroll-lock) aplique correctamente.
function AprendizajePanel({ edu, sinEvaluar, onClose, onRecalibrar, onLeccion }) {

...
function norm(s) {
  // NFD + quita acentos, y COLAPSA todo whitespace (espacios múltiples, tabs, saltos de línea) a un
  // solo espacio + trim ANTES del match: así los patrones multi-palabra ('comer menos', 'salta la')
  // no se evaden metiendo doble espacio/tab/newline entre las palabras (hardening TCA, defense-in-depth).

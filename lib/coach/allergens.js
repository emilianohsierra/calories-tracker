...
// Léxico plano de términos de alérgeno (normalizados + singulares), reusable por co-guardas
// externas — p.ej. el GUARD DE SALUD de save_memory (que una alergia no se guarde como
// memoria). Deriva de GROUPS + GROUP_TRIGGERS (una sola fuente de verdad).
export const ALLERGEN_TERMS = [
  ...new Set([...Object.values(GROUPS).flat(), ...Object.values(GROUP_TRIGGERS).flat()].flatMap(forms)),
];

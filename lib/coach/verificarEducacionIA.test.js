...
describe('verificarEducacionIA · B2 fuga de cifra META + I1 swap de unidad', () => {
  ...
  it('pero una INGESTA/META calórica nueva (1000 kcal al día) SIGUE bloqueando', () => {
    bloquea('Para bajar, apunta a 1000 kcal al día.', 'Los macronutrientes aportan energía.');
  });
});

...
import { sellosNOM051, inferirLiquido } from './nom051.js';
...
export function toProducto(p, brain) {
  ...
  out.sellos = sellosNOM051(out.nutricion, {
    isLiquid: inferirLiquido({ serving_unit: out.nutricion?.serving_unit, unidad: out.unidad, categoria: out.categoria }),
...
function offAProducto(off, codigo = '') {
  ...
  out.sellos = sellosNOM051(out.nutricion, {
    isLiquid: inferirLiquido({ serving_unit: off.serving_unit, unidad: out.unidad, categoria: out.categoria }),
    ingredientes: out.ingredientes,
  });
  return out;
}

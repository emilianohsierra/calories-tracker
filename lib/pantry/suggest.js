...
export const OBJETIVOS = new Set(['perdida_grasa', 'hipertrofia', 'runner', 'recomposicion', 'bienestar']);
...
// Score determinista COMPARTIDO (Fase 6 despensa + Recomendaciones v2 platillos): cuadre vs pendientes
// + bonus por objetivo. Mayor = mejor. PURA. nut = { kcal, prot, carb, fibra, gramos? }.
export function puntuarPorMacros(nut, pend, objetivo) {
...
export function quePuedoComer(pendientes, pantryItems, objetivo, restricciones, opts = {}) {
  ...
  opciones.forEach((o) => {
    o._score = puntuarPorMacros({ kcal: o.kcal, prot: o.macros.prot, carb: o.macros.carb, gras: o.macros.gras, fibra: o.fibra, gramos: o.gramos }, pend, obj);
  });

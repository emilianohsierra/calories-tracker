...
// Sanea una URL de imagen EXTERNA: sólo http/https se acepta (bloquea data:/javascript:/file:/
// rutas raras). Devuelve la URL saneada o '' (Slowking hardening — usar/guardar solo http).

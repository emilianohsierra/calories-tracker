...
describe('pantry/off · searchOFFByName (búsqueda por nombre → productos reales con code)', () => {
  it('mapea products[] y descarta los que no traen barcode', async () => {
    stubFetch({
      products: [
        { code: '7501055310333', product_name: 'Mayonesa McCormick Light', brands: 'McCormick', image_url: 'http://x/m.jpg', nutriments: { 'energy-kcal_100g': 350, proteins_100g: 1 } },
